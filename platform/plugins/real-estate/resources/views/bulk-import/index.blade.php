    ...
    <div class="row justify-content-center bulk-import">
        <div class="col-xxl-6 col-xl-8 col-lg-10 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('import-properties.store') }}" method="post" id="bulk-import-form">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-info">{{ trans('plugins/real-estate::property.import_properties') }}</button>
                        </div>
                    </form>
                </div>
            </div>
